...
if __name__ == "__main__":
    ...
    large_files_all = ["rd84_142", "adr4_197", "radd_250", "z4_268", "sym6_145", "misex1_241",
                   "rd73_252", "cycle10_2_110", "square_root_7", "sqn_258", "rd84_253"]
    
    '''
    large_files_all = ["rd84_142", "adr4_197", "radd_250", "rd84_253"]
    large_files = ["rd84_253"]
	'''
    ...
    base_command = "python -m nesq --dataset large --hardware qx20 --search 250 --numitersG 250 --large_files "
    ...
    df.to_csv('results_largedata_new_opt.csv', index_label='circuit_name')
    time_df.to_csv('results_time_data_largedata_new_opt.csv', index_label='circuit_name')
