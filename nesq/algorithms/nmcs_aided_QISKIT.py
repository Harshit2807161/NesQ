...
class NMCQAgent(CombinerAgent):
    ...
    def play (self,etat, move):
        ...
        etat.child_states[move] = NMCQAgent.NMCState(
    ...
    def playout(self,etat, rewards, L):
        ...
        L, solution,reward = self.qiskit_routing(node.state)
        '''
    ...
    def nested(self, etat, rewards, level, L):
        ...
        while True: 
            ...
            if len(bestSequence) == len(L) or etat1.state.is_done():
                break  
    ...
    def act(self,state,rewards):
        ...
        if self.root is None or self.root.state != state:
            self.root = NMCQAgent.NMCState(state, self.model)
        else:
        ...
        state: NMCQAgent.NMCState = self.root
    ...
    def qiskit_routing(self, state):
        ...
        #!!!!!!!!!!!!! either pass the updated circuit somehow, or change coupling map 
        ...
        return swap_indices,edges_involved_in_swaps,-tr_circuit.depth()
