...
class NMCAgentold(CombinerAgent):
    """
    ...
    def play (self,etat, move):
        ...
        next_sol[move] = True
        etat.child_states[move] = NMCAgentold.NMCState(
    ...
    def nested(self, etat, rewards, level, L):
        ...
        while True: 
            ...
            print("BS: ",bestSequence)
            print("L: ",L)                    
            print(len(bestSequence))
            print(len(L))
    ...
    def act(self,state,rewards):
        ...
        if self.root is None or self.root.state != state:
            self.root = NMCAgentold.NMCState(state, self.model)
        else:
        ...
        state: NMCAgentold.NMCState = self.root
